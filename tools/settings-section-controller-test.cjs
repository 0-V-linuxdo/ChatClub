...
(async () => {
  ...
  assert.match(profilesSource, /class: "api-profile-editor-layout"/);
  ...
  assert.match(stylesSource, /\.api-profile-editor-identity-name \{[^}]*font-size:\s*var\(--font-size-display\);/s);
