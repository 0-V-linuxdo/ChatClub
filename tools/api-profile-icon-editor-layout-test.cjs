...
assert.match(openIconEditor, /class: "settings-icon-editor-url-head"/);
assert.match(openIconEditor, /class: "settings-icon-editor-help tooltip-trigger"/);
assert.match(openIconEditor, /"data-tooltip-wrap": "true"/);
assert.match(openIconEditor, /svgIcon\("help"\)/);
...
assert.match(openIconEditor, /class: "settings-icon-editor-actions"/);
assert.match(openIconEditor, /class: "settings-icon-editor-upload"/);
assert.match(openIconEditor, /t\("apps\.iconUpload"\)/);
assert.match(openIconEditor, /svgIcon\("upload"\)/);
assert.match(openIconEditor, /class: "settings-icon-editor-tools"/);
assert.match(openIconEditor, /svgIcon\("refreshCw"\)/);
assert.match(openIconEditor, /t\("apps\.iconRefresh"\)/);
assert.match(openIconEditor, /svgIcon\("undo2"\)/);
assert.match(openIconEditor, /t\("apps\.iconRestore"\)/);
assert.doesNotMatch(openIconEditor, /iconButton\(/);
assert.doesNotMatch(openIconEditor, /svgIcon\("reload"\)/);
assert.doesNotMatch(openIconEditor, /svgIcon\("reset"\)/);
assert.doesNotMatch(openIconEditor, /button\(\s*t\("apps\.iconUpload"/);
assert.doesNotMatch(openIconEditor, /button\(\s*t\("apps\.iconRefresh"/);
assert.doesNotMatch(openIconEditor, /button\(\s*t\("apps\.iconRestore"/);
...
assert.doesNotMatch(openIconEditor, /el\("p", \{\s*class: "settings-icon-editor-help"/);
assert.doesNotMatch(openIconEditor, /appearance-overlay-info/);
