...
assert.match(openIconEditor, /iconButton\(\s*t\("apps\.iconRefresh"/);
assert.match(openIconEditor, /svgIcon\("refreshCw"\)/);
assert.match(openIconEditor, /iconButton\(\s*t\("apps\.iconRestore"/);
...
assert.doesNotMatch(openIconEditor, /(?<!icon)button\(\s*t\("apps\.iconRefresh"/);
assert.doesNotMatch(openIconEditor, /(?<!icon)button\(\s*t\("apps\.iconRestore"/);
