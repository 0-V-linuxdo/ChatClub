...
(async () => {
  ...
  try {
    ...
    const callSites = [
      ...
      ["app/settings/controller.js", "openApiProfileEditor", "editorModal", "API profile editor"],
      ["app/settings/controller.js", "openCustomAppEditor", "editorModal", "custom platform editor"],
      ["app/settings/controller.js", "openPromptTemplateEditor", "editorModal", "prompt template editor"],
      ["app/settings/controller.js", "openSummaryCollectorEditor", "editorModal", "Summary collector editor"],
      ["app/settings/controller.js", "openMessageNavigatorSiteEditor", "editorModal", "Message Navigator editor"],
      ["app/settings/controller.js", "openTopicDeleteSiteEditor", "editorModal", "Delete Site editor"],
      ["app/prompt-library/controller.js", "openPromptLibraryEditor", "editorModal", "Prompt Library editor"],
      ["app/workspace/controller.js", "openGoToUrlDialog", "editorModal", "Go To URL editor"],
      ["app/settings/controller.js", "openBuiltInAppDetails", "viewerModal", "built-in platform details"],
