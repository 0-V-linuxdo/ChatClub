...
const byteBudgets = Object.freeze({
  ...
  // Per-model Notion Effort menus add the bounded trigger/menu/settlement
  // capability to the preferred-model content boundary.
  "content/preferred-model.js": 236_740,
