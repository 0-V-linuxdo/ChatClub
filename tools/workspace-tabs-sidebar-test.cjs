...
(async () => {
...

  {
    ...
    const grid = Object.assign(new FakeNode("div"), { className: "main-grid", offsetTop: 69 });
    shell.append(grid);
    fixture.api.setOpen(true);
    ...
    assert.equal(sidebar?.style?.top, "69px");
  }
...

  {
    ...
    assert.match(String(confirmations[0].title || ""), /Delete “Closed research”|删除“Closed research”/);
