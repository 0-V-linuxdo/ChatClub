...
assert.match(agents, /DOM sibling of `\.prompt-input-row`/);
...
assert.match(css, /\.prompt-model-gate-status\.tooltip-trigger \{[\s\S]*?position:\s*absolute;\s*top:\s*calc\(100% \+ var\(--space-1\)\);/);
