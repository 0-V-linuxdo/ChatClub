...
assert.doesNotMatch(css, /\.workspace-tabs-search-mark\s*\{[^}]*32%,\s*transparent/);
assert.match(css, /forced-colors:\s*active[\s\S]{0,120}\.workspace-tabs-search-mark[\s\S]{0,80}color:\s*MarkText/);
