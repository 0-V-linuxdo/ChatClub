...
assert.match(contentScriptRegistration, /export async function prepareContentScriptRegistration/);
...
assert.doesNotMatch(main, /from "\.\/official-rules\/service\.js"/);
...
assert.match(main, /import\("\.\/official-rules\/service\.js"\)/);
