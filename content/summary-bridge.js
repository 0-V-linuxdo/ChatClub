(() => {
  ...
  var CONTENT_RUNTIME_SUMMARY_BRIDGE_BUNDLE_IDENTITY = /* @__PURE__ */ Object.freeze({ "outputPath": "content/summary-bridge.js", "entryPath": "content-src/content-summary-bridge.js", "sourceSha256": "6dfee1342e3fcef4e2a3087559b9e9fe5e85de9bc92014abf8cfd5f93286db77", "implementationSha256": "3d1bd134fef068669be6d07bef172b53d51987c4e1b8e15637783a8e3e526290", "implementationVersion": "2026.07.16.2+bundle.3d1bd134fef068669be6d07bef172b53d51987c4e1b8e15637783a8e3e526290" });
    ...
    async function collectOfficialStage(config, data, { wait = true } = {}) {
      ...
      const inspectOnce = () => {
        if (typeof inspectOfficialSummaryCollection2 === "function") {
          const inspection2 = inspectOfficialSummaryCollection2(config, {
            qsa: qsa2,
            closest: closest2,
            visible: visible2,
            normalize: normalize2
          ...
          return {
            messages: merge2(inspection2?.messages || []),
            hits: inspection2?.hits || null
          };
        }
        return {
          messages: merge2(collectOfficialSummaryMessages2?.(config, {
            qsa: qsa2,
            closest: closest2,
            visible: visible2,
            normalize: normalize2
      ...
      let waitMsApplied = 0;
      if (!hasUserAndAssistant2(inspection.messages) && waitMs > 0 && typeof sleep2 === "function") {
        await sleep2(waitMs);
      ...
      return {
        messages: hasUserAndAssistant2(inspection.messages) ? inspection.messages : null,
