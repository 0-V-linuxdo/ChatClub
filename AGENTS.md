...
- Shell: `--topbar-height: 69px`; `--prompt-collapsed-height: 40px`; `--workspace-z-sidebar` / `--workspace-z-topbar` / `--workspace-z-topbar-edit` / `--workspace-z-topbar-controls`
