...
- Shell: `--topbar-height: 51px` (6px padding + 38px pill + 6px padding + 1px border; the 34px `.top-icon-action` controls were sized for this bar); `--prompt-collapsed-height: 40px` (center overlay; topbar slot 38px); `--workspace-z-sidebar` / `--workspace-z-topbar` / `--workspace-z-topbar-edit` / `--workspace-z-topbar-controls`
