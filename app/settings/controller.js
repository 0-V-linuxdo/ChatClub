...
export function createSettingsController(ctx) {
  ...
  function topbarPromptPlaceholderRawText(value) {
    return String(value ?? "").replace(/\s+/g, " ").trim();
  }

  function topbarPromptPlaceholderPreview(value, limit = 120) {
  ...
  function moveTopbarPromptPlaceholderItems(items, sourceIndex, targetIndex, placement) {
