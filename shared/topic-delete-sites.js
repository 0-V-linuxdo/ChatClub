...
export const TOPIC_DELETE_SITE_CONFIGS = Object.freeze([
  ...
  descriptor({ id: "claude", name: "Claude", appIds: ["Claude"], hosts: ["claude.ai", "*.claude.ai"], pathPrefixes: ["/chat"], scriptId: "claude", scriptVersion: "2026.07.26.3", userscriptFile: "topic-delete-userscripts/claude.user.js", userscriptLength: 114532, userscriptTimeoutMs: 15000 }),
