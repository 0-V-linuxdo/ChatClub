...
export const TOPIC_DELETE_SITE_CONFIGS = Object.freeze([
  descriptor({ id: "chatgpt", name: "ChatGPT", appIds: ["ChatGPT"], hosts: ["chatgpt.com", "*.chatgpt.com", "chat.openai.com", "*.chat.openai.com"], pathPrefixes: [], scriptId: "chatgpt", scriptVersion: "2026.07.22.2", userscriptFile: "topic-delete-userscripts/chatgpt.user.js", userscriptLength: 90418, userscriptTimeoutMs: 15000 }),
  descriptor({ id: "claude", name: "Claude", appIds: ["Claude"], hosts: ["claude.ai", "*.claude.ai"], pathPrefixes: ["/chat"], scriptId: "claude", scriptVersion: "2026.07.26.7", userscriptFile: "topic-delete-userscripts/claude.user.js", userscriptLength: 135696, userscriptTimeoutMs: 15000 }),
  descriptor({ id: "gemini", name: "Gemini", appIds: ["Gemini"], hosts: ["gemini.google.com", "*.gemini.google.com"], pathPrefixes: ["/app"], scriptId: "gemini", scriptVersion: "2026.07.22.2", userscriptFile: "topic-delete-userscripts/gemini.user.js", userscriptLength: 126842, userscriptTimeoutMs: 24000 }),
  descriptor({ id: "kagi", name: "Kagi Assistant", appIds: ["Kagi"], hosts: ["assistant.kagi.com"], pathPrefixes: [], scriptId: "kagi", scriptVersion: "2026.07.22.2", userscriptFile: "topic-delete-userscripts/kagi.user.js", userscriptLength: 90318, userscriptTimeoutMs: 15000 }),
  descriptor({ id: "grok", name: "Grok", appIds: ["Grok"], hosts: ["grok.com", "*.grok.com", "grok.x.ai", "*.grok.x.ai"], pathPrefixes: ["/c/", "/chat/"], scriptId: "grok", scriptVersion: "2026.07.22.2", userscriptFile: "topic-delete-userscripts/grok.user.js", userscriptLength: 90387, userscriptTimeoutMs: 15000 }),
  descriptor({ id: "grokMirror", name: "Grok Mirror", appIds: ["GrokMirror"], hosts: ["gk.dairoot.cn", "*.gk.dairoot.cn"], pathPrefixes: ["/c/", "/chat/"], scriptId: "grok-mirror", scriptVersion: "2026.07.22.2", userscriptFile: "topic-delete-userscripts/grok-mirror.user.js", userscriptLength: 90369, userscriptTimeoutMs: 15000 }),
  descriptor({ id: "notion", name: "Notion AI", appIds: ["NotionAI"], hosts: ["app.notion.com", "notion.so", "www.notion.so", "*.notion.so"], pathPrefixes: [], scriptId: "notion", scriptVersion: "2026.07.22.2", userscriptFile: "topic-delete-userscripts/notion.user.js", userscriptLength: 90416, userscriptTimeoutMs: 15000 }),
  descriptor({ id: "deepseek", name: "DeepSeek", appIds: ["DeepSeek"], hosts: ["deepseek.com", "*.deepseek.com"], pathPrefixes: ["/a/chat", "/chat"], scriptId: "deepseek", scriptVersion: "2026.07.22.2", userscriptFile: "topic-delete-userscripts/deepseek.user.js", userscriptLength: 90341, userscriptTimeoutMs: 36000 })
]);
