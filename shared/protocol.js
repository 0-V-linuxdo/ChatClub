const GENERIC_POST_MESSAGE_SOURCE = "chatclub";
...
const NOTION_SEND_TEXT_SOURCE = "chatclub-notion-send-text:2026.07.15.2";
const NOTION_SEND_PROMPT_SOURCE = "chatclub-notion-send-prompt:2026.07.15.2";
const NOTION_SEND_TEXT_EVENT = "chatclub:notion-send-text:2026.07.15.2";
const NOTION_SEND_PROMPT_EVENT = "chatclub:notion-send-prompt:2026.07.15.2";
const NOTION_SEND_ACTIVATED_EVENT = "chatclub:notion-send-activated:2026.07.15.2";
const SEND_TEXT_POST_MESSAGE_SOURCE = "chatclub:send-text:2026.07.16.2";
const DELETE_THREAD_POST_MESSAGE_SOURCE = "chatclub:delete-thread:2026.07.16.2";
export const MESSAGE_NAVIGATOR_POST_MESSAGE_SOURCE = "chatclub:message-navigator:2026.07.16.2";
const SUMMARY_POST_MESSAGE_SOURCE = "chatclub:summary:2026.07.16.2";
const PREFERRED_MODEL_POST_MESSAGE_SOURCE = "chatclub:preferred-model:2026.07.16.2";
export const CONTENT_BRIDGE_VERSION = "2026.07.16.2";
export const GROK_COOKIE_BRIDGE_VERSION = "2026.07.28.3";
export const EXTENSION_RUNTIME_RELAY_SOURCE = "chatclub:runtime-relay:2026.07.16.2";
